...
public class AStarDebugger : MonoBehaviour
{
    ...
    private void CreateDebugTile(Vector3 wolrdPos, Color32 color, Node node = null)
    {
        GameObject debugTile = Instantiate(debugTileprefab, wolrdPos, Quaternion.identity);
